...
export default function PdfTool() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div
        className={`grid ${
          items.length ? "md:grid-cols-2" : "grid-cols-1"
        } gap-8`}
      >
        {/* Upload Section */}
        <div className="bg-white shadow-lg rounded-2xl p-8 text-center border-2 border-dashed border-gray-300">
          {!items.length && (
            <p className="text-gray-500 mb-4">
              Upload images or add text to create your PDF
            </p>
          )}
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition font-medium shadow-md inline-block"
            >
              ➕ Add Text
            </button>
          </div>
